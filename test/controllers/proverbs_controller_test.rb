...
class ProverbsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proverb" do
    assert_difference('Proverb.count') do
      post proverbs_url, params: { proverb: { active: @proverb.active, english: @proverb.english, translation: @proverb.translation } }
    end
  ...
  test "should update proverb" do
    patch proverb_url(@proverb), params: { proverb: { active: @proverb.active, english: @proverb.english, translation: @proverb.translation } }
